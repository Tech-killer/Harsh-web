  ...
  >
      ...
      <div className="container mx-auto px-4 py-8 flex flex-col md:flex-row items-center">
        <div className="md:w-1/3 mb-8 md:mb-0">
          <img
            src="https://www.linkedin.com/me?trk=p_mwlite_feed-secondary_nav"
            alt="Profile Picture"
        ...
        <div className="md:w-2/3 md:pl-12">
          ...
          <div className="mt-8 flex space-x-4">
            ...
            <a href="https://github.com/Tech-killer?tab=overview&from=2024-07-01&to=2024-07-31" className="text-gray-900 hover:text-white">
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.instagram.com/harsh.jsharma?igsh=MWo3bDZ3OWszMzE1dw==" className="text-orange-600 hover:text-white">
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="mailto:Harsh.jsharma0304@gmail.com" className="text-white hover:text-white">
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
